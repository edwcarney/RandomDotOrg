...
Julia functions to provide support for obtaining random numbers generated by the <a href="https://random.org">RANDOM.ORG</a> website.

From the RANDOM.ORG <a href="https://www.random.org/faq">FAQ</a>:
...
The RANDOM.ORG website uses radios tuned to atmospheric noise
